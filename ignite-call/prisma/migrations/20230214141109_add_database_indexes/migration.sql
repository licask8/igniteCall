...
-- DropForeignKey
ALTER TABLE `scredulings` DROP FOREIGN KEY `scredulings_user_id_fkey`;
...
-- RenameIndex
ALTER TABLE `scredulings` RENAME INDEX `scredulings_user_id_fkey` TO `scredulings_user_id_idx`;
